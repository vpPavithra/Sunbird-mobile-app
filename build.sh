...
NODE_OPTIONS=--max-old-space-size=8192 ionic cordova platforms add android@10.1.2

NODE_OPTIONS=--max-old-space-size=8192 ionic cordova build android production --release --verbose --buildConfig ./buildConfig/build.json
